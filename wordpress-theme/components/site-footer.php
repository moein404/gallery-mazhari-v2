...
<footer class="mds-site-footer" id="contact" dir="rtl" aria-label="پاورقی سایت گالری مظهری">
    ...
    <div class="mds-site-footer__main mds-container">
        ...
        <div class="mds-site-footer__contact">
            ...
            <div class="mds-site-footer__maps" aria-label="مسیریابی شعبه سعدی">
                <a
                    class="mds-site-footer__map"
                    href="https://maps.app.goo.gl/9fa53PgVd72SQFCL7"
                    target="_blank"
                    rel="noopener noreferrer"
                >Google Maps</a>
                <a
                    class="mds-site-footer__map"
                    href="https://nshn.ir/91rbvgQ6NxiuH_"
                    target="_blank"
                    rel="noopener noreferrer"
                >نشان</a>
            </div>
        ...
        <div class="mds-site-footer__contact">
            ...
            <div class="mds-site-footer__maps" aria-label="مسیریابی شعبه خانه عروس">
                <a
                    class="mds-site-footer__map"
                    href="https://maps.app.goo.gl/vYe9QNMD8gygJM336"
                    target="_blank"
                    rel="noopener noreferrer"
                >Google Maps</a>
                <a
                    class="mds-site-footer__map"
                    href="https://nshn.ir/05rbvgtjVxO6l_"
                    target="_blank"
                    rel="noopener noreferrer"
                >نشان</a>
            </div>
